...
(require
  ...
  (quote fuchi.methods.test-rail-liquidity-warifu)
  (quote fuchi.methods.test-tooling-okaimono-receive)
  (quote fuchi.methods.test-tooling-okaimono-produce-plan)
  (quote fuchi.methods.test-compute-murakumo-receive)
  (quote fuchi.methods.test-compute-murakumo-produce-plan)
  (quote fuchi.methods.test-housing-commons-receive)
  (quote fuchi.methods.test-housing-commons-produce-plan)
  (quote fuchi.methods.test-liquidity-warifu-receive)
  (quote fuchi.methods.test-itonami-surplus-ledger)
  (quote fuchi.methods.test-displacement-l0-path)
  (quote fuchi.methods.test-liberation-ladder)
  (quote fuchi.methods.test-stage-sustenance)
  (quote fuchi.methods.test-disclosure-continuity)
  (quote fuchi.methods.test-displacement-book)
  (quote fuchi.methods.test-displacement-couple)
  (quote fuchi.methods.test-r2-execute)
  (quote fuchi.methods.test-pages-deploy)
