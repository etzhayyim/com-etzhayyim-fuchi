...
(defn gated-live-status
  "Non-raising R1→gated-live DESIGN status for care-iyashi (子・孫 multi-gen first).
   Default gate/env refuses. Never delivers care; cash≡0; live false."
      ...
      (try
        (let [plan (gated-live-plan r1-pkg g :env e :hold-machine hold-machine)
              out {:rail-kind RAIL-KIND
                   ...
                   :score-surface []
                   :priority-stack PRIORITY-STACK
                   :note "gated-live plan authorized — iyashi care delivery not invoked"}]
